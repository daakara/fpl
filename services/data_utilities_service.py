...
class DataUtilitiesService:
    ...
    def create_fallback_data(self):
        """Create comprehensive fallback data when API is unavailable"""
        return {
            "players": [
                {"name": "Haaland", "position": "Forward", "team": "Manchester City", "price": 15.1, "points": 156, "form": "8.2"},
                {"name": "Salah", "position": "Midfielder", "team": "Liverpool", "price": 12.7, "points": 138, "form": "6.8"},
                {"name": "Palmer", "position": "Midfielder", "team": "Chelsea", "price": 6.6, "points": 142, "form": "9.1"},
                {"name": "Saka", "position": "Midfielder", "team": "Arsenal", "price": 8.2, "points": 125, "form": "7.5"},
                {"name": "Son", "position": "Midfielder", "team": "Tottenham", "price": 9.5, "points": 118, "form": "6.9"}
            ],
            "teams": [
                {"name": "Arsenal", "short_name": "ARS", "strength": 5},
                {"name": "Manchester City", "short_name": "MCI", "strength": 5},
                {"name": "Liverpool", "short_name": "LIV", "strength": 5},
                {"name": "Chelsea", "short_name": "CHE", "strength": 4},
                {"name": "Tottenham", "short_name": "TOT", "strength": 4}
            ],
            "current_gameweek": 10,
